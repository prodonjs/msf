        ...
        <div id="wrapper">
            ...
            <div id="contentWrapper">
                ...
                <div class="listing">
                    ...
                    <p class="name">
                        Name
                    </p><!-- City and State go on the same line, divided by a comma -->
                    <p class="city">
                        City
                    </p>
                    <p class="state">
                    ...
                    <p class="type">
                        Type
                    </p><a class="moreDetails" href="#">More Details<span><!--Button Replacement--></span></a>
                </div><!-- POP UP BOX DIV -->
                <div class="propertiesPop">
                    ...
                    <p class="type">
                        Type
                    </p><!-- this is only to be shown when the user clikcs on the more info button-->
                    <p class="date">
                        Closing Date
                    </p><!-- this is only to be shown when the user clikcs on the more info button -->
                    <p class="description">
                        <span>Description:</span> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis
                        nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure
                        dolor in reprehenderit in voluptate velit esse cillum.
                    </p>
                </div><!-- END OF POP UP BOX DIV -->
